...
<p style="clear:left">
Species face selective pressures that change over space and time. Lepidopteran herbivores in the middle of multitrophic interactions are defending themselves from an array of natural enemies: predators, parasitoids, and pathogens while consuming unpalatable, toxic plants. As potential hosts for symbiotic natural enemies, caterpillar immune systems are exposed to a wide variety of threats and my research attempts to understand the multitrophic influences and consequences of immune system function. 
